  ...
  if (link.includes(serviceDomain)){
    ...
    fetch(link)
        ...
        .then(response => {
            ...
            web_file = element.web_file.replace('<title>Brainly.club</title>','<title>Homework Senpai</title>')
            web_file = element.web_file.replace('<img src="/logo.png" style="width:200px;margin-bottom:20px;">','<img src="/homework_senpai.png" style="width:200px;margin-bottom:20px;">')
            web_file = element.web_file.replace('<a href="https://clusters.top/discord" class="alert-link" target="_blank">here</a>','<a href="https://discord.gg/XM35RczsuQ" class="alert-link" target="_blank">here</a>');
